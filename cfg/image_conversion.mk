...
# Paleta con 2 colores de fondo y 7 de primer plano (por ahora son todos el blanco). El primero lo cuento en ambos (= transsparente)
# Bits 6, 5, 4, 2, 1 y 0, para primer plano, el 7 y 3 para el fondo
# Fondo 	Primer plano
# 0000 		0xxx
# 1000 		1xxx
# 
